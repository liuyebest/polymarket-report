...
def calculate_changes(current_price, history):
    """计算概率变化"""
    # 历史数据格式: {market_id: {"price_24h": x, "price_7d": y, "timestamp": t}}
    changes = {
        "change_24h_abs": 0,
        "change_7d_abs": 0,
        "change_24h_pct": 0,
...
<table>
<tr><th>#</th><th>Event</th><th>Current</th><th>24h Δ</th><th>7d Δ</th><th>End Date</th><th>24h Vol</th><th>Total Vol</th></tr>'''
